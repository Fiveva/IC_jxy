...
mouse_id = 79; % <-- 设为 21 处理 M21 数据，设为 79 处理 M79 数据
...
TITLE_TEXT = sprintf('M%d 神经元活动强度波形图', mouse_id);
...
try
    ...
    % whole_trace_ori 格式: 20722 * 6232 single (神经元数量 * 拍照记录数)
...
ylabel('神经元活动平均强度 (Average Fluorescence)');
